...
late SharedPreferences prefs; //13번째줄 전역변수
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    bool isOnboarded = prefs.getBool("isOnboarded") ?? false; // null false 넣음
    return MaterialApp(
      ...
      home: isOnboarded
          ? HomePage()
          : onboardingPage(), // isOnboard true = Homepage false = onboarding
    );
  }
}
